...
const int Trigger1 = 4;   //Pin digital
const int Echo1 = 5;   //Pin digital
const int Trigger2 = 12;   //Pin digital
const int Echo2 = 11;   //Pin digital
...
int contador = 0;
int LED1 = 6; //led para prueba
int LED2 = 13; //led para prueba
int LEDtest = A2;
